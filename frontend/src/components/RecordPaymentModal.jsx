      ...
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-sunburn p-6 sm:p-8 text-[#152935] border border-[#ccd5d2] animate-pop-in">
        ...
        {selectedReceipt ? (
          ...
          <div className="text-center space-y-4">
            ...
            <div>
              <span className="bg-[#f1e5d6] text-[#152935] text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                Official Rent Receipt
              </span>
              <h3 className="text-xl font-black text-[#152935] mt-2">Receipt #{selectedReceipt.receiptNo}</h3>
            ...
            <div className="bg-[#f7f4ef] p-4 rounded-2xl border border-[#ccd5d2] text-xs space-y-2 text-left">
              <div className="flex justify-between border-b border-[#f1e5d6] pb-2">
                ...
                <span className="font-bold text-[#152935]">{selectedReceipt.studentName}</span>
              </div>
              <div className="flex justify-between border-b border-[#f1e5d6] pb-2">
                <span className="text-[#698ea2]">Billing Month</span>
                <span className="font-bold text-[#152935]">{selectedReceipt.month}</span>
              </div>
              <div className="flex justify-between border-b border-[#f1e5d6] pb-2">
              ...
              <div className="flex justify-between border-b border-[#f1e5d6] pb-2">
                ...
                <span className="font-bold text-[#152935]">{selectedReceipt.paymentMethod}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[#698ea2]">Date Settlement</span>
                <span className="font-bold text-[#152935]">{selectedReceipt.paidDate}</span>
              </div>
            </div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="w-full bg-[#f1e5d6] hover:bg-[#ccd5d2] text-[#152935] font-bold py-3 rounded-xl text-xs flex items-center justify-center gap-1.5 transition cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full bg-[#152935] hover:bg-[#152935]/90 text-white font-bold py-3 rounded-xl text-xs transition cursor-pointer"
              >
                Done
              </button>
            </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#152935]">Collect Rent & Record Payment</h3>
