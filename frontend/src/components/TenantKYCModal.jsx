...
function TenantKYCModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#152935]/75 backdrop-blur-sm overflow-y-auto">
      <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-sunburn p-6 sm:p-8 text-[#152935] border border-[#ccd5d2] max-h-[90vh] overflow-y-auto animate-pop-in">
        ...
        <div className="flex items-center gap-4 mb-6 border-b border-[#f1e5d6] pb-4">
          <div className="w-14 h-14 rounded-2xl bg-[#152935] text-[#e4a576] flex items-center justify-center font-black text-xl shadow-md">
            {selectedStudentKYC.name.charAt(0)}
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-2xl font-black text-[#152935]">{selectedStudentKYC.name}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs font-semibold">
          ...
          <div className="space-y-4">
            <div className="bg-[#f7f4ef] p-4 rounded-2xl border border-[#ccd5d2] space-y-2.5">
              <h4 className="text-xs font-extrabold uppercase text-[#152935] tracking-wider mb-2 flex items-center gap-1.5">
                <FaUserShield className="text-[#698ea2]" /> Contact & Emergency Info
              </h4>
              <div className="flex items-center justify-between text-[#152935]">
            ...
            <div className="bg-[#f1e5d6]/60 p-4 rounded-2xl border border-[#ccd5d2] space-y-3">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="text-[11px] font-bold text-[#698ea2] hover:text-[#152935] underline cursor-pointer"
                >
                ...
                <form onSubmit={handleSaveKYC} className="space-y-3 pt-1">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white border border-[#ccd5d2] rounded-xl px-3 py-1.5 text-xs text-[#152935]"
                    />
                  </div>
                  <div>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#152935] text-white font-bold py-2 rounded-xl text-xs hover:bg-[#152935]/90 cursor-pointer"
                  >
                    Save Updated KYC Details
                  </button>
                </form>
              ) : (
                <div className="space-y-2 text-[#152935]">
                  ...
                  <div className="flex justify-between items-center pt-1">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1 bg-white border border-[#ccd5d2] text-[#152935] px-2.5 py-1 rounded-lg text-[10px] font-bold hover:bg-[#f1e5d6]"
                    >
          ...
          <div className="space-y-4">
              ...
              {tenantInvoices.length === 0 ? (
                ...
                <div className="space-y-2">
                  {tenantInvoices.map((inv) => (
                    ...
                    >
                      <div>
                        <span className="font-bold text-[#152935] block">{inv.month}</span>
                        <span className="text-[10px] text-[#698ea2]">
                          Rent: ₹{inv.rentAmount || inv.amount} {inv.electricityAmount ? `+ Elec: ₹${inv.electricityAmount}` : ""}
                        </span>
                      </div>
                      <div className="text-right">
                        <span className="font-bold text-[#152935] block">₹{inv.amount?.toLocaleString()}</span>
                        <span
            ...
            <button
              ...
              className="w-full bg-[#152935] hover:bg-[#152935]/90 text-white font-bold py-3 rounded-2xl transition cursor-pointer text-xs"
            >
